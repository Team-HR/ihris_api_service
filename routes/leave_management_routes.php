...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/api/leave-management/fetch-all-leave-applications', [LeaveApplicationController::class, 'fetchLeaveApplications']);
    ...
    Route::get('/api/leave-management/get-immediate-supervisors', [LeaveApplicationController::class, 'getImmediateSupervisors']);
